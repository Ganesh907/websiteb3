...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        'zoom-design': {
          '0%, 33.33%': { opacity: 1, transform: 'scale(1,0)' },   // Zoom in "design"
        ...
        'zoom-develop': {
          ...
          '33.34%, 66.66%': { opacity: 1, transform: 'scale(1,0)' }, // Zoom in "develop"
        ...
        'zoom-deliver': {
          ...
          '66.67%, 100%': { opacity: 1, transform: 'scale(1,0)' }, // Zoom in "deliver"
