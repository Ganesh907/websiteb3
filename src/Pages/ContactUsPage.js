...
import ContactUSBg2 from '../Assets/Images/contact-us-content.gif'
...
export const ContactUsPage = () => {
        ...
        return (
                <div className='bg-white'>
                        <div
                                className="w-[100vw] relative h-[100vh] flex  justify-center flex-col lg:flex-row-reverse items-center align-middle"
                                style={{
                                        backgroundSize: 'cover',
                                        backgroundRepeat: 'no-repeat',
                                        backgroundPosition: 'center',
                                        // backgroundImage: `url(${WaveBg})`,
                                        // backgroundImage: `url(${VideoForContact})`,
                                        backgroundImage: window.innerWidth <= 768 ? `url(${WaveBg})` : 'none'
                                }}
                        >
 <video
        autoPlay
    ...
    >
        ...
        Your browser does not support the video tag.
                                ...
                                <div className='text-center relative z-10 md:text-white text-black opacity-90 flex flex-col justify-center px-9 lg:w-[50%] w-full h-full' 
                                // data-aos="zoom-in" data-aos-duration="2000"
                                >
                                        <h1 className='md:text-[3vw] text-[7vw] drop-shadow-2xl font-semibold font-serif '>
...
<div className='relative z-10 w-full lg:w-[51vw] h-full  md:mb-0 text-white flex justify-center items-center' data-aos="zoom-in" data-aos-duration="2000">
<div className='h-full md:w-[20%] md:flex justify-center items-center  hidden '>
        <h1 className='ms-[100%] text-2xl font-bold drop-shadow-lg z-50 border-2 border-white p-4 shadow-lg backdrop-blur-md' data-aos="fade-right" data-aos-duration="2000">

        CONTACT
        </h1>
        </div>
                                <div className="grid grid-cols-3 md:border-4 border-white  md:rounded-full lg:mt-10 p-2 h-[80%] md:h-[63%] md:shadow-2xl md:w-[60%]" 
                                ...
                                >
                                        ...
                                        <div className='bg-white rounded-full shadow-2xl text-[#0060b5]' >
                                ...
                                <div className='  h-full md:w-[20%] md:flex justify-center items-center hidden '>
        <h1 className='me-[100%] text-2xl font-bold drop-shadow-lg z-50  shadow-lg  p-4 backdrop-blur-md border-2 border-white'  data-aos="fade-left" data-aos-duration="2000">BITBYBIT
        </h1>
        </div>
                                </div>
                        ...
                        <div className=' bg-white w-[100vw] h-auto md:h-[100vh] flex justify-center  flex-col align-middle'>
                                <div className='w-[90%] rounded-lg p-3 lg:w-[80%] m-auto flex flex-col lg:flex-row'>
                                        <div className='flex justify-center  w-auto lg:w-[50%] rounded-lg p-2 bg-white align-middle'
