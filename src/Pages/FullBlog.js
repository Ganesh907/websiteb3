...
const handleClick=()=>{
  ...
  return (
    <div className="w-full min-h-screen  flex flex-col items-center justify-start py-10 px-5">
      <button
        onClick={onBack}
        className="self-start text-blue-500 underline mb-5"
      >
        Back to Blogs
      </button>

      <div 
      className={` w-full max-w-5xl rounded-lg shadow-lg p-6  ${darkMode ? 'bg-black/80 border' : 'bg-white'}`}
         ...
         <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            {blog.profileImage ? (
              ...
              <div className={`bg-[#0060b5] border-2  h-12 w-12 rounded-full flex items-center justify-center 
            ...
            <div className="ml-4">
              <h3 className={` font-semibold text-gray-800 ${darkMode ?'text-white':'text-gray-800'}`}>{blog.authorName}</h3>
              <div className={`flex items-center gap-1 ${darkMode ?'text-white':''}`}>
