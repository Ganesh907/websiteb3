    ...
    return (
        <div className="recrHomepageMain">
            ...
            <div className='h-[100vh] flex justify-start bg-[#0060b5] '>
              <div className='h-14 flex justify-center animate-ping  items-end text-[200px] rounded-full  w-14 absolute bottom-0 right-[12%] text-white z-50 ' style={{animationDuration:"4000ms"}}>
                <KeyboardDoubleArrowDownIcon  className="animate-bounce" style={{fontSize:"50px",animationDuration:"400ms"}}/> 
                </div>
...
<div className="relative w-full h-32 overflow-hidden">
      ...
      >
        {quotes.map((quote, index) => (
          <div key={index} className="w-full flex-shrink-0 p-5 bg-white bg-opacity-70 text-black drop-shadow-xl">
            <p>{quote}</p>
          </div>
        ))}
      </div>
