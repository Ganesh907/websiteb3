...
const RecHomePage = () => {
  ...
  return (
    <div className="recrHomepageMain">
      ...
      <div className="h-[100vh] flex justify-start bg-[#0060b5] ">
        <div
          className="h-14 flex justify-center animate-ping  items-end text-[200px] rounded-full  w-14 absolute bottom-0 right-[12%] text-white z-50 "
          style={{ animationDuration: "4000ms" }}
        >
          <KeyboardDoubleArrowDownIcon
            className="animate-bounce"
            style={{ fontSize: "50px", animationDuration: "400ms" }}
          />
        </div>

        <div className=" z-10 w-[50vw] h-[100vh] flex justify-end  items-end">
          <div className=" w-full font-bold mx-10  my-20 drop-shadow-xl">
            <div className=" flex items-center">
              ...
              <SearchIcon
                className="text-black bg-white scale-75"
                sx={{ fontSize: "60px" }}
              />
            </div>

            <div className=" flex items-center">
              <h1 className="drop-shadow-lg text-white text-6xl my-10 font-bold border-b-8 border-[#0060b5] pb-1">
                Build Your Career
              </h1>
  ...
  Build Your Career
            ...
            <div className="relative w-full h-32 overflow-hidden">
              ...
              >
                {quotes.map((quote, index) => (
                  <div
                    key={index}
                    className="w-full flex-shrink-0 p-5 bg-white bg-opacity-70 text-black drop-shadow-xl"
                  >
                    <p>{quote}</p>
                  </div>
                ))}
        ...
        <img
          ...
          style={{ opacity: 0.5 }} // Makes the entire image slightly transparent
        />
        <div
          className="absolute top-0 left-0 w-full h-full"
          style={{
            backgroundColor: "rgba(0, 96, 181, 0.5)", // Transparent blue overlay
          }}
        ></div>
        <div
      ...
      <div className="h-[100vh] w-full  flex flex-col justify-center items-center">
        ...
        <h1
          className="text-7xl mt-10 drop-shadow-xl"
          data-aos="zoom-in"
          data-aos-duration="1000"
        >
          Our Seeking Process
        </h1>
        <p className="w-[50%] my-10">
          Find jobs by checking job vacancy and recruitment websites, social
          media, professional and industry journals, and by going to career
                  ...
                  <div className="icon-border-bottom">
                    ...
                    <div className="icon-card__description">
                      ...
                      <p className="small text-center">
                        We help organisations hire expert full-time talent for
                        middle, senior and top level positions across diverse
                        sectors.
                      </p>
                    </div>
                  </div>
                ...
                <div className="card-content-blue">
                  <div className="icon-border-bottom">
                    ...
                    <div className="icon-card__description">
                      ...
                      <p className="small text-center">
                        Building an agile and flexible workforce requires an
                        easy and fast access to expert talent, available on
                        short notice. We offer a pool of pre-screened talent,
                        hired on our rolls.
                      </p>
                    </div>
                  </div>
                ...
                <div className="card-content">
                  <div className="icon-border-bottom">
                    ...
                    <div className="icon-card__description">
                      ...
                      <p className="small text-center">
                        Our Temp-to-Hire services allow organisations the
                        opportunity to evaluate a candidate over a period of
                        time before on-boarding the candidate at the end of the
                        contract period.
                      </p>
                    </div>
                  </div>
