  ...
  return (
    <>
      <div className="service-div-main">
        ...
        <span
          className="w-[8%] h-[5px] ml-[3%] hidden md:block rounded-b-[5px]"
          style={{ backgroundColor: "#002eff" }}
        ></span>
        ...
        <div className=" w-full  bg-white ml-2 h-screen justify-start">
          <div>
            ...
            <span
              className="w-[8%] h-[5px] ml-[3%] block rounded-b-[5px]"
              style={{ backgroundColor: "#002eff" }}
            ></span>
          </div>
        ...
        <section className="service-section">
          <div className="service-div">
            <div className="service-content-section">
              <p className="tech-service-p font-bold">
                Founded and Headed by Tech savvy, like minded people, BitByBit
                has been offering state-of-the-art technology solutions to its
                ...
                clients the best technological solutions in the form of
                customized software applications whether web based or mobile
                based. All our technology solutions are delivered bug-free. We
                offer an extremely development lifecycle to ensure an
                uninterrupted service. We deliver exactly what you need.
              </p>
            </div>
          </div>
        </section>
      ...
      <div className="tech-footer">{/* <Footer /> */}</div>
    </>
  );
};
