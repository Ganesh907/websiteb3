            ...
            <div className="md:flex md:flex-col  ">
              <div className="  ">
                ...
                <div className="md:pl-2  md:flex md:justify-center   ">
                  <ul className="text-gray-700 list-disc leading-loose font md:h-[275px] md:pt-6 md:pl-80 ml-1 md:w-[100%] md:line-break:anywhere">
