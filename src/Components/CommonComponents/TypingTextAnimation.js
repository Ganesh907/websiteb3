...
const TypingText = () => {
  ...
  return (
    ...
    <div className="w-[90vw]  flex mx-auto my-4  text-4xl font-bold mb-20  text-gray-800 ">
      <h1 className="  text-blue-500 mr-2  ">{constantText} : </h1>
      <h2 className=" text-white ">{displayedText}</h2>
    </div>
  );
};
